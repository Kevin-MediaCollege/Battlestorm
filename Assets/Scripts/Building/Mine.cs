...
public class Mine : Building {
	...
	void changeArt(int upgrade){
		...
		switch(upgrade){
		case 1:
			art = Instantiate(Resources.Load("Prefabs/Test/Mine/Mine"),transform.position,Quaternion.identity) as GameObject;
			break;
		case 2:
			art = Instantiate(Resources.Load("Prefabs/Test/Mine/Mine2"),transform.position,Quaternion.identity) as GameObject;
			break;
		case 3:
			art = Instantiate(Resources.Load("Prefabs/Test/Mine/Mine3"),transform.position,Quaternion.identity) as GameObject;
			break;
		case 4:
			art = Instantiate(Resources.Load("Prefabs/Test/Mine/Mine4"),transform.position,Quaternion.identity) as GameObject;
			break;
		case 5:
			art = Instantiate(Resources.Load("Prefabs/Test/Mine/Mine5"),transform.position,Quaternion.identity) as GameObject;
			break;
		}
